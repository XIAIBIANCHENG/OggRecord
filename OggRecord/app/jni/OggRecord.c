...
int Java_com_example_aacrecord_OggRecord_writeAudioData(JNIEnv* env, jobject thiz, jbyteArray pcmData,jint len){
...
/* 初始化ffmpeg                                                                     */
/************************************************************************/
int Java_com_example_aacrecord_OggRecord_initRecord(JNIEnv* env, jobject thiz, jstring* outputFile){
	...
	audioStream = addAudioStream(outputCtx, AV_CODEC_ID_VORBIS);
...
/* 关闭                                                                                                                                                                            */
/************************************************************************/
void Java_com_example_aacrecord_OggRecord_closeRecord(JNIEnv* env, jobject thiz){
