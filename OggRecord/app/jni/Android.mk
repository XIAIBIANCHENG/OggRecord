...
ifeq ($(TARGET_ARCH_ABI),armeabi)
    LOCAL_SRC_FILES := ./ffmpeg/armv5te/libswresample.a
else
    LOCAL_SRC_FILES := ./ffmpeg/armv7-a/libswresample.a
endif
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_STATIC_LIBRARIES := avformat avcodec avutil swresample fdk_aac
LOCAL_MODULE := oggrecord
